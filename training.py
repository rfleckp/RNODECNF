...
from training_utils import ExactOptimalTransportConditionalFlowMatcher, aug_ode, reg_aug_mnist, choose_timesteps, compute_bits_per_dim
...
def train_mnist_node(params):
    ...
    for epoch in range(1, params['n_epochs']+1):
        ...
        for i, (samples, labels) in progress_bar:
            ...
            logp_x = -1*0.5*torch.sum(z1.reshape((z1.shape[0],-1))**2,dim=1,keepdim=True) + l1
            loss = -logp_x.mean()
